...
BASE_HEIGHT_TARGET = 0.35 # base height target for rewards, set as an attribute of the env config.
...
@configclass
class DMBotSceneCfg(InteractiveSceneCfg):
    """Configuration for the terrain scene with the DMBot robot."""
...
class EventCfg:
    ...
    randomize_rigid_body_mass_others = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="^(?!.*L0_torso).*"), 
...
class RewardsCfg:
    ...
    undesired_contacts = RewTerm(
        ...
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_hipp|.*_knee"), "threshold": 5.0},
    )
    ...
    hip_pos_penalty_l1 = RewTerm(
        ...
        params={
            "command_name": "base_velocity",
            "asset_cfg": SceneEntityCfg("robot", joint_names=".*_hipr"),
    ...
    joint_pos_penalty_l1 = RewTerm(
        ...
        params={
            "command_name": "base_velocity",
            "asset_cfg": SceneEntityCfg("robot", joint_names=".*_(hipp|knee)"),
            "stand_still_scale": 1.0,
...
@configclass
class DMBotEnvCfg(ManagerBasedRLEnvCfg):
    """Merged configuration for the DMBot robot on rough terrain."""

    # Scene settings
    scene: DMBotSceneCfg = DMBotSceneCfg(num_envs=8192, env_spacing=0.5)
    # Basic settings
