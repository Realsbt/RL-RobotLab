...
if TYPE_CHECKING:  # Avoid circular import for type checking
    from robot_lab.tasks.dmbot.env.go2_env import Go2Env
...
from robot_lab.tasks.dmbot.mdp.utils import is_robot_on_terrain, sample_disjoint_intervals, sample_single_interval
