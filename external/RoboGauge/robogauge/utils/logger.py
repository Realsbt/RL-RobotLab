...
class Logger:
    ...
    def _get_logger(self):
        if self.logger is None:
            self.logger = logging.getLogger("robogauge_fallback")
            self.logger.addHandler(logging.NullHandler())
        return self.logger

    def debug(self, msg, *args, **kwargs):
        self._get_logger().debug(msg, *args, **kwargs, stacklevel=2)
    
    def info(self, msg, *args, **kwargs):
        self._get_logger().info(msg, *args, **kwargs, stacklevel=2)
    
    def warning(self, msg, *args, **kwargs):
        self._get_logger().warning(msg, *args, **kwargs, stacklevel=2)

    def error(self, msg, *args, **kwargs):
        self._get_logger().error(msg, *args, **kwargs, stacklevel=2)

    def critical(self, msg, *args, **kwargs):
        self._get_logger().critical(msg, *args, **kwargs, stacklevel=2)
